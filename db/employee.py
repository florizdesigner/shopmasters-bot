...
class EmployeeController:
    ...
    def get_all_employees(self):
        try:
            ...
            response = DBResponse(status="success", message=None, employee=employees).to_dict()
    ...
    def get_employee_by_id(self, id: int):
        try:
            ...
            employee = cursor.execute(f"SELECT * FROM employees WHERE id = {id}").fetchone()
            response = DBResponse(status="success", message=None, employee=employee).to_dict()
    ...
    def delete_employee(self, id: int):
        try:
            ...
            db_connection.commit()
            response = DBResponse(status="success", message=f"User id: {id} is successfully deleted from DB", employee=None).to_dict()
